    ...
    if (totalCount == 0) {
        return (
            <button className="py-2 px-4 flex gap-2 border-1 border-black justify-center rounded-full absolute bg-white bottom-0 left-[50%] -translate-x-[50%] translate-y-[50%] hover:cursor-pointer" onClick={handleClick}>
                <img src={import.meta.env.BASE_URL + "/assets/images/icon-add-to-cart.svg"} alt="" />
        ...
        return (
            <button className="rounded-full p-2 flex justify-around text-white bg-(--color-red) gap-10 absolute bottom-0 left-[50%] -translate-x-[50%] translate-y-[50%] hover:cursor-pointer">
                <div onClick={handleClick} className="p-2 border-1 border-white rounded-[50%] grid place-items-center increment"><img src={import.meta.env.BASE_URL + "/assets/images/icon-increment-quantity.svg"} alt="" className="size-3"/></div>
                {totalCount}
                <div onClick={handleClick} className="p-2 border-1 border-white rounded-[50%] grid place-items-center decrement"><img src={import.meta.env.BASE_URL + "/assets/images/icon-decrement-quantity.svg"} alt="" className="size-3"/></div>
            </button>
        )
    }
}